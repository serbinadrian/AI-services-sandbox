...
import { image_generation } from "./image_generation_pb_service";
...
class NeuralImageGeneration extends React.Component {
  constructor(props) {
    ...
    this.handleStyleParameterChange = this.handleStyleParameterChange.bind(
      this
    );
  ...
  renderSliders() {
    ...
    return sliderParamsKeys.map((sliderParameterKey) => {
      const sliderParameter = this.state.diffusionSliderParams[
        sliderParameterKey
      ];
