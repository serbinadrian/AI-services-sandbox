...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  image_generation_snet_image_generation.Text.displayName =
    "image_generation_snet_image_generation.Text";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  image_generation_snet_image_generation.Image.displayName =
    "image_generation_snet_image_generation.Image";
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  image_generation_snet_image_generation.Text.prototype.toObject = function (
    opt_includeInstance
  ) {
    return image_generation_snet_image_generation.Text.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   */
  image_generation_snet_image_generation.Text.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
image_generation_snet_image_generation.Text.deserializeBinary = function (
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new image_generation_snet_image_generation.Text();
  return image_generation_snet_image_generation.Text.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!image_generation_snet_image_generation.Text}
 */
image_generation_snet_image_generation.Text.deserializeBinaryFromReader =
  function (msg, reader) {
 ...
 * @return {!Uint8Array}
 */
image_generation_snet_image_generation.Text.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    image_generation_snet_image_generation.Text.serializeBinaryToWriter(
      this,
      writer
    );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
image_generation_snet_image_generation.Text.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {string}
 */
image_generation_snet_image_generation.Text.prototype.getSentence =
  function () {
    return /** @type {string} */ (
 ...
 */
image_generation_snet_image_generation.Text.prototype.setSentence = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setDalle = function (
  value
) {
 ...
 * @return {boolean}
 */
image_generation_snet_image_generation.Text.prototype.getBeksinski =
  function () {
    return /** @type {boolean} */ (
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setBeksinski = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setGuohua = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setWaifu = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setSeedval = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setNImages = function (
  value
) {
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setSteps = function (
  value
) {
 ...
 * @return {string}
 */
image_generation_snet_image_generation.Text.prototype.getPromptStyle =
  function () {
    return /** @type {string} */ (
 ...
 * @return {!image_generation_snet_image_generation.Text} returns this
 */
image_generation_snet_image_generation.Text.prototype.setPromptStyle =
  function (value) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  image_generation_snet_image_generation.Image.prototype.toObject = function (
    opt_includeInstance
  ) {
    return image_generation_snet_image_generation.Image.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  image_generation_snet_image_generation.Image.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
image_generation_snet_image_generation.Image.deserializeBinary = function (
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new image_generation_snet_image_generation.Image();
  return image_generation_snet_image_generation.Image.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!image_generation_snet_image_generation.Image}
 */
image_generation_snet_image_generation.Image.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
image_generation_snet_image_generation.Image.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    image_generation_snet_image_generation.Image.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 */
image_generation_snet_image_generation.Image.prototype.setImage1 = function (
  value
) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
